...
characters =  alphabet[:]
modelPath = "/root/sdcard/data/tgz/CHINESE-OCR/ocr/my_model_keras.h5"#os.path.join(os.getcwd(), "ocr/my_model_keras.h5")
...
if os.path.exists(modelPath):
	...
	#model = load_model('/root/sdcard/data/tgz/CHINESE-OCR/ocr/my_model_keras.h5')  
	onnx_model = keras2onnx.convert_keras(basemodel, basemodel.name)
	temp_model_file = '/root/sdcard/data/tgz/CHINESE-OCR/ocr/my_model_keras.h5.onnx'
